        ...
        <div class="header__top">
            <div class="ps-container">
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="{{ route('homepage')}}"><img src="{{asset('assets/img/logo_light.png')}} " alt="" /></a>
                </div>
                    ...
                    <form class="ps-form--quick-search" action="index.html" method="get">
                        ...
                        <div class="ps-panel--search-result">
                            <div class="ps-panel__content">
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('assets/img/products/arrivals/1.jpg')}}
                                    " alt="" /></a></div>
                    ...
                    <div class="header__actions"><a class="header__extra" href="#"><i class="icon-chart-bars"></i><span><i>0</i></span></a><a class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
                        <div class="ps-cart--mini"><a class="header__extra" href="#"><i class="icon-bag2"></i><span><i>{{ $cartCount }}</i></span></a>
                            <div class="ps-cart__content">
                                ...
                                <div class="ps-cart__footer">
                                    <h3>Sub Total:<strong>XAF {{ number_format($cartTotal) }}</strong></h3>
                                    <figure><a class="ps-btn" href="{{ route('viewCart')}}">View Cart</a><a class="ps-btn" href="checkout.html">Checkout</a></figure>
                                </div>
                            </div>
                        </div>
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right">
                                 ...
                                 @else
                                     @if($user->role_id==1)
                                          <a href="{{ route('admin.dashboard') }}" target="_blank">Account</a>
                                     @endif
                                     @if($user->role_id==2)
                                           <a href="{{ route('db.vendor.index') }}" target="_blank">Account</a>
                                     @endif
                                     @if($user->role_id==3)
                                           <a href="{{ route('db.customer.index') }}" target="_blank">Account</a>
                                     @endif
                                     @if($user->role_id==4)
                                           <a href="{{ route('db.shipper.index') }}" target="_blank">Account</a>
                                     @endif
                                    
                                     <form method="POST" action="{{ route('logout') }}" id="logout">
                                        @csrf
                                    </form>
                                    <a id="logout_action" href="#">Logout</a>
                                 @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="ps-container">
                ...
                <div class="navigation__right">
                    ...
                    <ul class="navigation__extra">
                        ...
                        @endphp
                        <li>
                            <div class="ps-dropdown language"><a href="#"><img src="{{asset('assets/img/flag/'.$lang.'.png')}}" alt="" />{{ $language}}</a>
                                <ul class="ps-dropdown-menu">
                                    <li><a href="{{ route('lang', ['locale'=>'fr'])}}"><img src="{{asset('assets/img/flag/fr.png')}}" alt="" /> Français</a></li>
                                    <li><a href="{{ route('lang', ['locale'=>'en'])}}"><img src="{{asset('assets/img/flag/en.png')}}" alt="" /> English</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
    ...
    <header class="header header--mobile" data-sticky="true">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left"><a class="ps-logo" href="index.html"><img src="{{asset('assets/img/logo_light.png')}}" alt="" /></a></div>
            <div class="navigation__right">
