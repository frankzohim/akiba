...
<body>
    <header class="header--mobile">
        ...
        <div class="header__center"><a class="ps-logo" href="#"><img src="{{ asset('backoffice/admin/img/logo.png')}}" alt=""></a></div>
                ...
                <div class="ps-section__right">
                    ...
                    <section class="ps-card ps-card--top-country">
                        ...
                        <div class="ps-card__content">
                            ...
                            </div><img src="{{ asset('backoffice/admin/img/map-and-bundle.png')}}" alt="">
