                        ...
                        <div class="ps-product__header">
                            <div class="ps-product__thumbnail" data-vertical="true">
                                    ...
                                    <div class="ps-wrapper">
                                        <div class="ps-product__gallery" data-arrow="true">
                                            @foreach($product['images'] as $image)
                                                <div class="item"><a href="img/products/detail/fullwidth/1.jpg"><img src="{{ route('display.product.image',['id'=>$product['id'], 'path'=>$image['id']] )}}" alt=""></a></div>
                                            @endforeach
                                        </div>
                                    </div>
                                </figure>
                                ...
                                <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                                    @foreach($product['images'] as $image)
                                        <div class="item"><img src="{{ route('display.product.image',['id'=>$product['id'], 'path'=>$image['id']] )}}" alt=""></div>
                                    @endforeach
                                </div>
                            </div>
                            <div class="ps-product__info">
                                ...
                                <div class="ps-product__meta">
                                    <p>Brand:<a href="shop-default.html">{{ $product['brand']['name']}}</a></p>
                                ...
                                <h4 class="ps-product__price" id="product-price-{{$product['id']}}">
                                    {{ $product['price']}}
                                </h4>
                                <div class="ps-product__desc">
                                    <p>Sold By:<a href="shop-default.html"><strong> {{ $product['store']['name']}}</strong></a></p>
